...
import {
  ...
  SettingButton,
  BUTTON_TEXT,
  initialData as Button_initData,
  eventActions as Button_eventActions,
  Icon as BUTTON_Icon,
} from './button';
export {
  ELEMENT_BUTTON,
...
import {
  ...
  SettingCheckbox,
  CHECKBOX_TEXT,
  initialData as Checkbox_initData,
  eventActions as Checkbox_eventActions,
  Icon as CHECKBOX_Icon,
} from './checkbox';
export {
  ELEMENT_CHECKBOX,
  RenderCheckbox,
...
import {
  ...
  SettingContainer,
  CONTAINER_TEXT,
  initialData as Container_initData,
  eventActions as Container_eventActions,
  Icon as CONTAINER_Icon,
} from './container';
export {
  ELEMENT_CONTAINER,
  RenderContainer,
...
import {
  ...
  SettingDate,
  DATE_TEXT,
  initialData as Date_initData,
  eventActions as Date_eventActions,
  Icon as DATE_Icon,
} from './date';
...
import {
  ...
  SettingImage,
  IMAGE_TEXT,
  initialData as Image_initData,
  eventActions as Image_eventActions,
  Icon as IMAGE_Icon,
} from './image';
...
import {
  ...
  SettingInput,
  INPUT_TEXT,
  initialData as Input_initData,
  eventActions as Input_eventActions,
  Icon as INPUT_Icon,
} from './input';
...
import {
  ...
  SettingNumber,
  NUMBER_TEXT,
  initialData as Number_initData,
  eventActions as Number_eventActions,
  Icon as NUMBER_Icon,
} from './number';
export {
  ELEMENT_NUMBER,
...
import {
  ...
  SettingRadio,
  RADIO_TEXT,
  initialData as Radio_initData,
  eventActions as Radio_eventActions,
  Icon as RADIO_Icon,
} from './radio';
...
import {
  ...
  SettingSearch,
  SEARCH_TEXT,
  initialData as Search_initData,
  eventActions as Search_eventActions,
  Icon as SEARCH_Icon,
} from './search';
export {
  ELEMENT_SEARCH,
...
import {
  ...
  SettingSelect,
  SELECT_TEXT,
  initialData as Select_initData,
  eventActions as Select_eventActions,
  Icon as SELECT_Icon,
} from './select';
export {
  ELEMENT_SELECT,
...
import {
  ...
  SettingSwitch,
  SWITCH_TEXT,
  initialData as Switch_initData,
  eventActions as Switch_eventActions,
  Icon as SWITCH_Icon,
} from './switch';
export {
  ELEMENT_SWITCH,
...
import {
  ...
  SettingTable,
  TABLE_TEXT,
  initialData as Table_initData,
  eventActions as Table_eventActions,
  Icon as TABLE_Icon,
} from './table';
...
import {
  ...
  SettingTabs,
  TABS_TEXT,
  initialData as Tabs_initData,
  eventActions as Tabs_eventActions,
  Icon as TABS_Icon,
} from './tabs';
...
import {
  ...
  SettingText,
  TEXT_TEXT,
  initialData as Text_initData,
  eventActions as Text_eventActions,
  Icon as TEXT_Icon,
} from './text';
...
import {
  ...
  SettingTime,
  TIME_TEXT,
  initialData as Time_initData,
  eventActions as Time_eventActions,
  Icon as TIME_Icon,
} from './time';
...
import {
  ...
  SettingUpload,
  UPLOAD_TEXT,
  initialData as Upload_initData,
  eventActions as Upload_eventActions,
  Icon as UPLOAD_Icon,
} from './upload';
export {
  ELEMENT_UPLOAD,
